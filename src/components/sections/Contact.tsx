        ...
        <div className="grid gap-6 sm:grid-cols-3">
          {CONTACT_CARDS.map(({ icon: Icon, label, value }) => (
            <button
              ...
              type="button"
              onClick={() => copy(value)}
              className="group glass flex flex-col items-start gap-4 rounded-3xl p-6 text-left transition hover:-translate-y-1 hover:border-line-strong"
            >
              ...
              <span className="min-w-0">
                ...
                <span className="mt-1 flex items-center gap-2 text-sm font-medium text-sand-50">
                  {value}
                  {copied === value ? (
          ...
          <div className="glass flex flex-col items-start gap-4 rounded-3xl p-6">
